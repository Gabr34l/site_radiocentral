...
for dia in dias_uteis:
    Grade.extend([
        {"nome": "Madrugada 101", "locutor": locutores["Equipe Central"], "dia": dia, "inicio": time(0,0), "fim": time(5,0)},
...
# Sábado
Grade.extend([
    {"nome": "101 Mais Tocadas", "locutor": locutores["Equipe Central"], "dia": 'sabado', "inicio": time(0,0), "fim": time(6,0)},
    ...
    {"nome": "101 Mais Tocadas", "locutor": locutores["Equipe Central"], "dia": 'sabado', "inicio": time(11,30), "fim": time(12,0)},
    ...
    {"nome": "101 Mais Tocadas", "locutor": locutores["Equipe Central"], "dia": 'sabado', "inicio": time(18,0), "fim": time(23,59,59)}, 
])
...
Grade.extend([
    ...
    {"nome": "101 Mais Tocadas", "locutor": locutores["Equipe Central"], "dia": 'domingo', "inicio": time(13,0), "fim": time(23,59,59)},
])
